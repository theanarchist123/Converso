-- Run this SQL in your Supabase dashboard to create the session_recaps table
...
-- Add RLS (Row Level Security) - Disabled for now since we're using Clerk
-- ALTER TABLE session_recaps ENABLE ROW LEVEL SECURITY;

-- Create RLS policy for Clerk users (string IDs) - Commented out for now
