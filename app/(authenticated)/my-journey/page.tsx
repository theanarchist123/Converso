        ...
        <main className="min-lg:w-3/4">
            <section className="flex justify-between gap-4 max-sm:flex-col items-center">
                ...
                <div className="flex gap-4">
                    <div className="border border-black dark:border-border rounded-lg p-3 gap-2 flex flex-col h-fit bg-white dark:bg-card transition-colors">
                    ...
                    <div className="border border-black dark:border-border rounded-lg p-3 gap-2 flex flex-col h-fit bg-white dark:bg-card transition-colors">
                        <div className="flex gap-2 items-center">
                            <Image src="/icons/cap.svg" alt="cap" width={22} height={22} className="dark:invert" />
